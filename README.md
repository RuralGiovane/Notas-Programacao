...
```text
├── Backend/          # Linguagens, frameworks, APIs e arquitetura
├── Frontend/         # HTML/CSS/JS, frameworks e estilização
├── Database/         # Bancos relacionais, NoSQL, PL/SQL e nuvem
├── Infra/            # Linux, terminais, redes, Git e DevOps
├── QA/               # Testes, TDD/BDD, automação e qualidade
└── Cyber/            # Segurança da informação e boas práticas
```
